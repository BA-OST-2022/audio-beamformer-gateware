  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "7b3fd8ca-cc74-4576-ae2f-c1039aca6aad",
          "type": "basic.constant",
          "data": {
            "name": "ROMFILE",
            "value": "\"sine.list\"",
        ...
        {
          "id": "59ad0d7d-c4e0-449c-99ce-706fea6a00e2",
          "type": "basic.constant",
          "data": {
            "name": "Value",
            "value": "100",
        ...
        {
          "id": "56b122f9-8ab9-4808-b768-689de1870ff2",
          "type": "basic.code",
          "data": {
            "code": "reg [15:0] rom [0:COUNT-1];\nreg [7:0] counter;\n\nalways @(posedge clk_in) begin\n  counter <= counter + 1;\n  if(counter == COUNT) begin\n    counter <= 0;\n  end\nend\n\ninitial begin\n    if (ROMFILE) $readmemh(ROMFILE, rom);\nend\n\nassign out = rom[counter];",
            "params": [
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "59ad0d7d-c4e0-449c-99ce-706fea6a00e2",
            "port": "constant-out"
          },
          "target": {
            "block": "56b122f9-8ab9-4808-b768-689de1870ff2",
            "port": "COUNT"
          }
        },
        {
          "source": {
            "block": "7b3fd8ca-cc74-4576-ae2f-c1039aca6aad",
            "port": "constant-out"
          },
          "target": {
            "block": "56b122f9-8ab9-4808-b768-689de1870ff2",
