  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "b03ecb0b-e5c2-4b1a-8e4a-5a73f4934480",
          "type": "basic.constant",
          "data": {
            "name": "ROMFILE",
            "value": "\"sine.list\"",
        ...
        {
          "id": "f4b36663-6f62-451b-8733-eb059afff6b6",
          "type": "basic.constant",
          "data": {
            "name": "MAX",
            "value": "100",
        ...
        {
          "id": "0148288a-c300-46ce-92df-67b3079302a0",
          "type": "basic.constant",
          "data": {
            "name": "Value",
            "value": "-16383",
        ...
        {
          "id": "83ab7f65-d816-4e7a-b3e1-a456250e8ae6",
          "type": "basic.memory",
          "data": {
            "name": "2",
            "list": "16383\n-16383",
        ...
        {
          "id": "20f2d44e-2470-43b1-9f36-1453f9ca117f",
          "type": "basic.memory",
          "data": {
            "name": "table",
            "list": "00\n01\n03\n07\n0F\n1F\n3F\n7F\nFF\nFE\nFC\nF8\nF0\nE0\nC0\n80",
        ...
        {
          "id": "f154ccaa-14e8-450b-a61a-75f70dfe3d36",
          "type": "basic.code",
          "data": {
            "code": "reg [15:0] counter;\nreg out = 1'b0;\n\nalways @(posedge clk_in) begin\n  counter <= counter + 1;\n  if(counter == N / 2) begin\n    counter <= 0;\n    out <= ~out;\n  end\nend\n\nassign clk_out = out;",
            "params": [
        ...
        {
          "id": "ec64ed37-3708-4cea-8cc0-9af318e2900b",
          "type": "basic.info",
          "data": {
            "info": "1 kHz",
            "readonly": true
        ...
        {
          "id": "d35a85b3-70cf-4bf7-95f0-81d56e3b8e85",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "8ce60c09-beda-4f3a-8eef-8ee5c809902a",
          "type": "34688e4806a6119bdbe88b4751825a9428852b1b",
          "position": {
            "x": 1792,
            "y": -552
        ...
        {
          "id": "10007c1f-ee0d-4bce-b469-2ba277f51586",
        ...
        {
          "id": "0d33a110-674b-4fef-b453-5339a3bab449",
          "type": "basic.code",
          "data": {
            "code": "reg [15:0] rom [0:4095];\nwire [11:0] A;\nreg [15:0] D;\n\nalways @(negedge clk) begin\n  D <= rom[A];\nend\n\ninitial begin\n    if (ROMFILE) $readmemh(ROMFILE, rom);\nend\n",
            "params": [
              {
                "name": "ROMFILE"
              }
        ...
        {
          "id": "302dc34d-ddcd-462a-930b-de53f3e9ca1a",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "b4c8eabc-fc82-46a2-80b2-f41244db65b0",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "adeae489-563a-45fe-a5dc-ef983936d238",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "f154ccaa-14e8-450b-a61a-75f70dfe3d36",
            "port": "clk_out"
          },
          "target": {
            "block": "302dc34d-ddcd-462a-930b-de53f3e9ca1a",
            "port": "clk_in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "f4b36663-6f62-451b-8733-eb059afff6b6",
            "port": "constant-out"
          },
          "target": {
            "block": "f154ccaa-14e8-450b-a61a-75f70dfe3d36",
        ...
        {
          "source": {
            "block": "0148288a-c300-46ce-92df-67b3079302a0",
            "port": "constant-out"
          },
          "target": {
            "block": "8ce60c09-beda-4f3a-8eef-8ee5c809902a",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "b03ecb0b-e5c2-4b1a-8e4a-5a73f4934480",
            "port": "constant-out"
          },
          "target": {
            "block": "0d33a110-674b-4fef-b453-5339a3bab449",
            "port": "ROMFILE"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "10007c1f-ee0d-4bce-b469-2ba277f51586",
        ...
        {
          "source": {
            "block": "20f2d44e-2470-43b1-9f36-1453f9ca117f",
            "port": "memory-out"
          },
          "target": {
            "block": "b4c8eabc-fc82-46a2-80b2-f41244db65b0",
            "port": "ROMFILE"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "adeae489-563a-45fe-a5dc-ef983936d238",
