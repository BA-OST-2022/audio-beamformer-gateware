  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "8167fea2-06a3-438c-90f0-2d2142b77147",
          "type": "basic.code",
          "data": {
            "code": "reg bit = 0;\n\nalways @(posedge clk)\nbegin\n  bit <= !bit;\n  if(bit) out <= in[0];\n  else out <= in[1];\nend\n",
            "params": [],
        ...
        {
          "id": "223f8194-050a-4be4-916c-cf64b5742efe",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "8167fea2-06a3-438c-90f0-2d2142b77147",
            "port": "out"
          },
          "target": {
        ...
        {
          "source": {
            "block": "223f8194-050a-4be4-916c-cf64b5742efe",
            "port": "ffdd9aa2-aea3-4aa9-8431-80e799226774"
          },
          "target": {
            "block": "a616f32d-0cf9-4843-85e4-a4693c689c09",
